...
import { DataEntryCreateProjectPage } from './DataEntryCreateProjectPage';
...
import './dataentry-project-detail.css';

interface DataEntryProjectDetailPageProps {
  project: Project;
  onBack: () => void;
...
export function DataEntryProjectDetailPage({ project, onBack, onUpdateProject, onDelete }: DataEntryProjectDetailPageProps) {
